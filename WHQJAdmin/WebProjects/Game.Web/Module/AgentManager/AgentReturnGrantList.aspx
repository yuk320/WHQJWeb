<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentReturnGrantList.aspx.cs" Inherits="Game.Web.Module.AgentManager.AgentReturnGrantList" %>
          ...
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor = this.style.backgroundColor;this.style.backgroundColor = '#caebfc';this.style.cursor = 'default';"
              ...
              <td>
                ...
                <td><%# Eval("TargetBefore") %></td>
              <td>
                <%# EnumDescription.GetFieldText((AppConfig.AwardType)Convert.ToByte(Eval("TradeType").ToString())) %>
              </td>
              <td>
                <%# Eval("Amount") %>
              </td>

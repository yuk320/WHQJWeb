...
namespace Game.Web.Module.AgentManager
{
    public partial class AgentReturnGrantList : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ddlAwardType.Items.Insert(0, new ListItem("全部转赠类型", "0"));
            BindData();
        }
        /// <summary>
        /// 搜索按钮的功能
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            if (awardType > 0)
            {
                sqlWhere += $" AND TradeType = {awardType} ";
            }
        ...
        {
            PagerSet pagerSet = FacadeManage.aideAgentFacade.GetList(ReturnAwardGrant.Tablename, anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);

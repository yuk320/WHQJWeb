    ...
    public partial class AgentReturnReceiveList : AdminPage
    {
        ...
        protected void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(query))
            {
                ...
                sqlWhere += $" AND UserID IN ({sqlUserId}) ";
            }
        ...
        {
            PagerSet pagerSet = FacadeManage.aideAgentFacade.GetList(ReturnAwardReceive.Tablename, anpNews.CurrentPageIndex, anpNews.PageSize, SearchItems, Orderby);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentReturnRecordList.aspx.cs" Inherits="Game.Web.Module.AgentManager.AgentReturnRecordList" %>
        ...
        <asp:Repeater ID="rptDataList" runat="server">
          <ItemTemplate>
            <tr align="center" class="list" onmouseover="currentcolor = this.style.backgroundColor;this.style.backgroundColor = '#caebfc';this.style.cursor = 'default';"
              ...
              <td>
                <a href="javascript:;" class="l" onclick="openWindowOwn('/Module/AccountManager/AccountsBaseInfo.aspx?param=<%# Eval("SourceUserID") %>')"><%# GetGameName(Convert.ToInt32(Eval("SourceUserID"))) %></a>
              </td>
              <td>
                <a href="javascript:;" class="l" onclick="openWindowOwn('/Module/AccountManager/AccountsBaseInfo.aspx?param=<%# Eval("TargetUserID") %>')"><%# GetGameName(Convert.ToInt32(Eval("TargetUserID"))) %></a>
              </td>
              <td>
                <%# Eval("AwardLevel") %>
              </td>
